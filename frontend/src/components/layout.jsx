      ...
      <div className="container flex h-16 max-w-screen-2xl items-center justify-between px-4 md:px-8 mx-auto">
        <div className="flex items-center gap-8">
          ...
          >
            ...
            <span className="font-bold text-xl hidden sm:inline-block tracking-tight font-serif">
              AgriConnect
            </span>
          </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          {user ? (
            <div className="hidden md:flex items-center gap-4 ml-2 pl-4 border-l border-primary-foreground/20">
              <Link
                href="/profile"
                className="flex items-center gap-2 hover:bg-primary-foreground/10 px-3 py-1.5 rounded-full transition-colors"
          ...
          <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
            ...
            <SheetContent
              side="right"
              className="w-[300px] sm:w-[400px] border-border bg-background"
            >
              <SheetTitle className="sr-only">Navigation Menu</SheetTitle>
              <SheetDescription className="sr-only">
                Main navigation for AgriConnect
              </SheetDescription>
                ...
                <div className="mt-auto flex flex-col gap-4 border-t border-border pt-6">
                  {user ? (
                    <>
                      <Link
                        href="/profile"
                        className="flex items-center gap-3 px-4 bg-muted/30 py-3 rounded-lg"
                        onClick={() => setIsMobileMenuOpen(false)}
                      >
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4 lg:grid-cols-5">
          <div className="lg:col-span-2 flex flex-col gap-4">
            ...
            <p className="text-sm text-primary-foreground/70 max-w-xs leading-relaxed mt-2">
              The assured contract farming marketplace connecting reliable
              growers with serious buyers for a more predictable agricultural
              supply chain.
            </p>
          </div>
          <div>
            <h3 className="font-semibold mb-4 text-secondary font-serif text-lg">
              Platform
            </h3>
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/20 text-center text-sm text-primary-foreground/60 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <span className="flex items-center gap-1">
              Grounded in trust <Leaf className="h-3 w-3 text-secondary" />{" "}
              Grown with care
            </span>
          </div>
        </div>
