        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-12 lg:p-20 text-primary-foreground">
          ...
          <div>
            ...
            <p className="text-xl text-primary-foreground/80 max-w-md">
              Join thousands of farmers and buyers transforming the agricultural
              supply chain through direct, reliable contracts.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md mx-auto space-y-6">
          <div>
            ...
            <p className="text-muted-foreground text-lg">
              Join the marketplace for assured farming contracts.
            </p>
          </div>
                    ...
                    <FormControl>
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <div
                            className={`p-3 rounded-full ${field.value === "farmer" ? "bg-primary text-primary-foreground" : "bg-background"}`}
                          >
                        ...
                        >
                          ...
                          />
                          <div
                            className={`p-3 rounded-full ${field.value === "buyer" ? "bg-secondary text-secondary-foreground" : "bg-background"}`}
                          >
