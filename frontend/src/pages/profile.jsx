      ...
      <div className="bg-primary/5 py-10 border-b border-border/40">
        <div className="container mx-auto px-4 md:px-8 max-w-5xl">
          ...
          <p className="text-lg text-muted-foreground mt-2 max-w-xl">
            Manage your public presence in the AgriConnect network.
          </p>
        </div>
      </div>
            ...
            <Card className="rounded-3xl border-secondary/20 shadow-sm bg-secondary/5">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Your identity has been verified in the AgriConnect network,
                  building trust with potential{" "}
                  {isFarmer ? "buyers" : "growers"}.
                </p>
              </CardContent>
            </Card>
          </div>
              ...
              <div className="bg-muted/30 px-8 py-6 border-b border-border/60 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    This information is shared with contracted partners.
                  </p>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <Input
                      ...
                      className="h-12 bg-muted/30 border-border text-base"
                    />
                  </div>
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <Input
                      ...
                      disabled
                      className="h-12 bg-muted/50 border-border/50 text-base text-muted-foreground"
                    />
                ...
                <div className="divide-y divide-border/40">
                  <div className="p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Get notified when partners send you a direct message or
                        propose a contract.
                      </p>
                    </div>
                  ...
                  <div className="p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Manage your password, connected devices, and two-factor
                        authentication.
                      </p>
                    </div>
                    <Button
