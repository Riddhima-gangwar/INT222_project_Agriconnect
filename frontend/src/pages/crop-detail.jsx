      ...
      <Layout>
        <div className="container mx-auto px-4 py-32 text-center max-w-lg">
          ...
          <p className="text-muted-foreground text-lg mb-8">
            This agricultural listing doesn't exist or has been removed from the
            marketplace.
          </p>
    ...
    <Layout>
      <div className="bg-primary pt-10 pb-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-6xl relative z-10">
          <Button
            variant="ghost"
            className="mb-6 -ml-4 text-primary-foreground/80 hover:text-primary-foreground hover:bg-primary-foreground/10"
            asChild
          >
        ...
        <div className="bg-card rounded-3xl shadow-xl border border-border/60 overflow-hidden mb-12">
          <div className="flex flex-col lg:flex-row">
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white flex justify-between items-end">
                <div>
                  <Badge className="bg-secondary text-secondary-foreground hover:bg-secondary mb-3 shadow-lg">
                    {crop.category.charAt(0).toUpperCase() +
                      crop.category.slice(1)}
                  </Badge>
            ...
            <div className="w-full lg:w-1/2 flex flex-col p-8 md:p-12">
              <div className="mb-8">
                <h1 className="text-3xl md:text-4xl font-bold font-serif tracking-tight text-foreground mb-4 leading-tight">
                  {crop.title}
                </h1>
              ...
              <div className="mt-auto">
                {isOwner ? (
                  <Button
                    variant="outline"
                    className="w-full h-14 text-lg rounded-full border-border"
                    asChild
                  >
                  ...
                  <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                    <DialogTrigger asChild>
                      <Button
                        ...
                        size="lg"
                        data-testid="btn-propose-contract"
                      >
                        Propose Contract
                      </Button>
                    </DialogTrigger>
                                ...
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <Input
                                      ...
                                      step="any"
                                      {...field}
                                      data-testid="input-proposal-quantity"
                              ...
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input
                                    ...
                                    {...field}
                                    data-testid="input-proposal-location"
                                    className="h-12 bg-muted/50 border-border/60"
                                  />
                                </FormControl>
                                <FormMessage />
                  ...
                  <Button
                    className="w-full h-14 text-lg rounded-full bg-secondary text-secondary-foreground hover:bg-secondary/90"
                    asChild
                  >
            ...
            <section>
              ...
              <div className="space-y-6">
                <div className="flex gap-5 bg-card p-6 rounded-3xl border border-border/50 shadow-sm">
                  <div className="w-12 h-12 rounded-full bg-primary/10 text-primary flex items-center justify-center shrink-0 font-serif font-bold text-xl">
                    1
                  </div>
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Specify your required quantity, price, and delivery terms.
                      The farmer will be notified immediately.
                    </p>
                  </div>
                </div>
                <div className="flex gap-5 bg-card p-6 rounded-3xl border border-border/50 shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Chat directly with the farmer on our platform to clarify
                      details and reach a mutual agreement.
                    </p>
                  </div>
                </div>
                <div className="flex gap-5 bg-card p-6 rounded-3xl border border-border/50 shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Once accepted, track the progress, coordinate logistics,
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground font-medium flex items-center gap-2">
                      <Briefcase className="w-4 h-4" /> Contracts
                    </span>
                    <span className="font-bold text-foreground bg-muted px-2.5 py-0.5 rounded-md">
                      {crop.contractsCount} active
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground font-medium flex items-center gap-2">
                    ...
                    <span className="font-bold text-green-600 bg-green-50 dark:bg-green-900/20 px-2.5 py-0.5 rounded-md">
                      &gt; 95%
                    </span>
                  </div>
                </div>
