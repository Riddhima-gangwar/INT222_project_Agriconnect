        ...
        <div className="container relative z-10 mx-auto px-4 md:px-8 text-center max-w-4xl pt-10">
          <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100 fill-mode-both">
            ...
            <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed drop-shadow-md">
              Connect directly with serious buyers and reliable farmers.
              Negotiate fair terms, secure contracts, and build long-term
              agricultural partnerships rooted in trust.
            </p>
              ...
              {!user ? (
                <>
                  <Link href="/register">
                    <Button
                      size="lg"
                      className="w-full sm:w-auto text-lg h-14 px-8 bg-secondary text-secondary-foreground hover:bg-secondary/90 shadow-xl shadow-secondary/20"
                  ...
                  <Link href="/marketplace">
                    <Button
                      variant="outline"
                      size="lg"
                      className="w-full sm:w-auto text-lg h-14 px-8 border-white/30 text-white hover:bg-white/10 hover:text-white backdrop-blur-sm"
      ...
      <section className="py-24 md:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          <div className="text-center max-w-3xl mx-auto mb-16 animate-in fade-in slide-in-from-bottom-8 duration-700">
            ...
            <h3 className="text-3xl md:text-5xl font-bold font-serif mb-6 text-foreground">
              Rooted in transparency.
            </h3>
            <p className="text-muted-foreground text-lg md:text-xl">
              A secure, streamlined workflow designed to protect the harvest and
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            <div className="relative z-10 bg-card border border-border/60 rounded-3xl p-8 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
              ...
              <h4 className="text-2xl font-serif font-semibold mb-4 text-foreground">
                Discover & Connect
              </h4>
              <p className="text-muted-foreground leading-relaxed text-lg">
                Farmers list their upcoming yields. Buyers search the
                marketplace for specific crops, certified qualities, and precise
                delivery timelines.
              </p>
            </div>
            ...
            <div className="relative z-10 bg-primary border border-primary-foreground/10 text-primary-foreground rounded-3xl p-8 shadow-lg shadow-primary/10 hover:-translate-y-1 transition-transform duration-300">
              ...
              <p className="text-primary-foreground/80 leading-relaxed text-lg">
                Communicate directly via our platform. Agree on fair pricing,
                exact quantities, quality standards, and harvest logistics
                without middlemen.
              </p>
            </div>
            ...
            <div className="relative z-10 bg-card border border-border/60 rounded-3xl p-8 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-muted-foreground leading-relaxed text-lg">
                Sign a legally binding digital contract. Track the growing
                progress, manage the final delivery, and release milestone
                payments securely.
              </p>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
              <div className="max-w-2xl">
                ...
                <p className="text-lg text-muted-foreground">
                  Explore high-quality yields currently available for forward
                  contracting.
                </p>
              </div>
              <Link href="/marketplace">
                  ...
                  <div className="relative h-[400px] rounded-3xl overflow-hidden shadow-md">
                    ...
                    <div className="absolute inset-0 p-6 flex flex-col justify-end">
                      <div className="mb-auto flex justify-between">
                        ...
                        <Badge
                          variant="outline"
                          className="bg-background/20 text-white border-white/30 backdrop-blur-md"
                        >
              ...
              <ul className="space-y-8">
                <li className="flex group">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed text-lg">
                      Lock in prices before harvest to protect against market
                      volatility. Farmers guarantee their income, buyers
                      guarantee their margins.
                    </p>
                  </div>
                </li>
                <li className="flex group">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed text-lg">
                      Grow with confidence knowing your buyer is secured. Buyers
                      get guaranteed supply volume for their operations without
                      the scramble.
                    </p>
                  </div>
                </li>
                <li className="flex group">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed text-lg">
                      Cut out unnecessary middlemen who squeeze margins. Build
                      long-term, mutually beneficial relationships directly
                      across the table.
                    </p>
                  </div>
                </li>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -left-8 bg-card border border-border p-6 rounded-2xl shadow-xl max-w-[280px] animate-in slide-in-from-bottom-4 duration-1000 delay-300">
                ...
                <p className="text-sm text-muted-foreground italic">
                  "Direct contracting gave me the security to invest in better
                  organic inputs."
                </p>
              </div>
            </div>
      ...
      <section className="py-24 bg-primary relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 text-center relative z-10">
          ...
          <p className="text-xl text-primary-foreground/80 mb-10 max-w-2xl mx-auto">
            Join thousands of growers and buyers building a more resilient,
            profitable, and transparent food system.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/register">
              <Button
                size="lg"
                className="w-full sm:w-auto h-14 px-8 text-lg bg-secondary text-secondary-foreground hover:bg-secondary/90 rounded-full"
              >
                Get Started Today
              </Button>
            </Link>
            <Link href="/marketplace">
              <Button
                variant="outline"
                size="lg"
                className="w-full sm:w-auto h-14 px-8 text-lg border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 hover:text-primary-foreground rounded-full"
              >
                Explore the Market
              </Button>
            </Link>
