...
import { useLoginUser, LoginBody } from "@workspace/api-client-react";
    ...
    <div className="min-h-[100dvh] w-full flex bg-background">
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-12 lg:p-20 text-primary-foreground">
          ...
          <div>
            ...
            <p className="text-xl text-primary-foreground/80 max-w-md">
              Secure contracts, transparent pricing, and guaranteed delivery for farmers and buyers alike.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-4 sm:px-12 md:px-20 lg:px-24">
        ...
        <div className="w-full max-w-md mx-auto space-y-8">
          <div>
            <h1 className="text-3xl sm:text-4xl font-bold font-serif text-foreground tracking-tight mb-2">Welcome back</h1>
            <p className="text-muted-foreground text-lg">Enter your details to sign in to your account.</p>
          </div>
          ...
          <div className="pt-6 text-center text-muted-foreground border-t border-border">
            ...
            <Link href="/register" className="font-bold text-primary hover:text-secondary transition-colors" data-testid="link-signup">
              Sign up today
            </Link>
          </div>
        </div>
